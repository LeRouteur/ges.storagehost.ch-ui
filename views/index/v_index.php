    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin/students.php">Liste des élèves</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin/invoices.php">Factures</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin/prices.php">Liste des prix</a>
                </li>
            </ul>
